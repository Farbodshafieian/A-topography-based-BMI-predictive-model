...
# start prediction: 
df_test, df_train, df_bp = TOPF.main_TOPF_kfold(df_fmri, fmricondition, clfname, nroi, seed, subject_list, df_pheno, Famid, Fmem, phenostr, J_model, Result_struct, feature_dir, feature_type, pcind, ntr, threshold, k_inner=2, k_outer=3, flip=None, clean=None, norm=1)
